...
*/
var subtraction = calculator (3,8);
var multiplication = calculator (3,8);
var division = calculator (3,8);
var mod= calculator (3,8);
/*
...
console.log(subtraction(function subtraction(num1, num2){
  return num1 - num2;
 }));

  console.log( 'O resultado da multiplicação é:' );
  console.log(multiplication(function multiplication(num1, num2){
    return num1 * num2;
 }));

console.log( 'O resultado da divisão é:' );

  console.log(division(function division(num1, num2){
    return num1 / num2;
 }));

console.log( 'O resto da divisão é:' );
console.log(mod(function mod(num1, num2){
  return num1 % num2;
 }));
