...
console.log(text.replace(/Manuel Marques de Sousa/g, 'Lisanja Nestle'));
...
console.log( text.replace(/"O Centauro de Luvas"/g, function(name){
...
console.log( '\nMeses representados por números:' );
  ...
  function getMonthNumber(monthName){
    ...
    var months = {
      janeiro : '01',
    fevereiro : '02',
        março : '03',   //março está entre aspas por causa do cedilha
        abril : '04',
          maio: '05',
        junho : '06',
        julho : '07',
