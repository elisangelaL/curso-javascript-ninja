...
}); // Se no lugar do filter eu usasse map(), retornaria [true, false, true, true, true, false, true, false, true, true];
...
console.log( '\nOperation:' );
  ...
  var operation = justMod2Or3.reduce(function(acumulado, atual, indice, array){
...
console.log( '\nOperation 2:' );
  ...
  }, 0);// Não sei pq, mas o retorno está sendo zero!, no console web está ok!
...
console.log( '\nSeu nome na língua do "P":' );
  ...
  var  name = [ 'Li', 'san', 'ge', 'la'];
  var reduceP = name.reduce(function(acumulado, atual){
  return acumulado + 'P' + atual;
  
  }, ''); //string em branco
  //No console do google não funcionou, pq?
  //saida: PLiPsanPgePla
...
//Poderia ter usado name.reverse().join('');
/*
